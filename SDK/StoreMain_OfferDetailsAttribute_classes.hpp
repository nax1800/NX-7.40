...
public:
	...
	class UCommonTextBlock*                       Name_StoreMain_OfferDetailsAttribute_C;            // 0x0248(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UStoreMain_OfferDetailsAttribute_C, Name_StoreMain_OfferDetailsAttribute_C) == 0x000248, "Member 'UStoreMain_OfferDetailsAttribute_C::Name_StoreMain_OfferDetailsAttribute_C' has a wrong offset!");
