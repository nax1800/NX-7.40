...
static_assert(offsetof(AGC_DUDEBRO_Summon_GroundEffect_C, Index_GC_DUDEBRO_Summon_GroundEffect_C) == 0x0008C8, "Member 'AGC_DUDEBRO_Summon_GroundEffect_C::Index_GC_DUDEBRO_Summon_GroundEffect_C' has a wrong offset!");
