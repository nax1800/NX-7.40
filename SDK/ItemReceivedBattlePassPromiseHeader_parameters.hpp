...
static_assert(offsetof(ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000008, "Member 'ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText, CallFunc_Subtract_IntInt_ReturnValue) == 0x00000C, "Member 'ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText, K2Node_MakeArray_Array) == 0x0000C0, "Member 'ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText, CallFunc_GetContext_ReturnValue) == 0x0000D0, "Member 'ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText, CallFunc_Format_ReturnValue) == 0x0000D8, "Member 'ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText, CallFunc_GetCurrentSeasonNumber_ReturnValue) == 0x0000F0, "Member 'ItemReceivedBattlePassPromiseHeader_C_UpdateSeasonText::CallFunc_GetCurrentSeasonNumber_ReturnValue' has a wrong offset!");
