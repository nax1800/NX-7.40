...
static_assert(alignof(PowerWidget_C_Get_RatingValueMinusLarge) == 0x000008, "Wrong alignment on PowerWidget_C_Get_RatingValueMinusLarge");
static_assert(sizeof(PowerWidget_C_Get_RatingValueMinusLarge) == 0x000030, "Wrong size on PowerWidget_C_Get_RatingValueMinusLarge");
static_assert(offsetof(PowerWidget_C_Get_RatingValueMinusLarge, ReturnValue) == 0x000000, "Member 'PowerWidget_C_Get_RatingValueMinusLarge::ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_Get_RatingValueMinusLarge, CallFunc_GetText_ReturnValue) == 0x000018, "Member 'PowerWidget_C_Get_RatingValueMinusLarge::CallFunc_GetText_ReturnValue' has a wrong offset!");
