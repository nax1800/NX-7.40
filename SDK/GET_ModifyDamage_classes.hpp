...
static_assert(alignof(UGET_ModifyDamage_C) == 0x000008, "Wrong alignment on UGET_ModifyDamage_C");
static_assert(sizeof(UGET_ModifyDamage_C) == 0x0005F0, "Wrong size on UGET_ModifyDamage_C");
