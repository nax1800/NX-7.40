...
static_assert(alignof(UserDefinedCaptureProtocol_BindToStream) == 0x000004, "Wrong alignment on UserDefinedCaptureProtocol_BindToStream");
static_assert(sizeof(UserDefinedCaptureProtocol_BindToStream) == 0x000018, "Wrong size on UserDefinedCaptureProtocol_BindToStream");
static_assert(offsetof(UserDefinedCaptureProtocol_BindToStream, StreamName) == 0x000000, "Member 'UserDefinedCaptureProtocol_BindToStream::StreamName' has a wrong offset!");
static_assert(offsetof(UserDefinedCaptureProtocol_BindToStream, Handler) == 0x000008, "Member 'UserDefinedCaptureProtocol_BindToStream::Handler' has a wrong offset!");
...
static_assert(alignof(UserDefinedCaptureProtocol_PushBufferToStream) == 0x000008, "Wrong alignment on UserDefinedCaptureProtocol_PushBufferToStream");
static_assert(sizeof(UserDefinedCaptureProtocol_PushBufferToStream) == 0x000010, "Wrong size on UserDefinedCaptureProtocol_PushBufferToStream");
static_assert(offsetof(UserDefinedCaptureProtocol_PushBufferToStream, Buffer) == 0x000000, "Member 'UserDefinedCaptureProtocol_PushBufferToStream::Buffer' has a wrong offset!");
static_assert(offsetof(UserDefinedCaptureProtocol_PushBufferToStream, StreamName) == 0x000008, "Member 'UserDefinedCaptureProtocol_PushBufferToStream::StreamName' has a wrong offset!");
...
static_assert(sizeof(UserDefinedCaptureProtocol_ResolveBuffer) == 0x000020, "Wrong size on UserDefinedCaptureProtocol_ResolveBuffer");
...
static_assert(offsetof(UserDefinedCaptureProtocol_ResolveBuffer, BufferName) == 0x000008, "Member 'UserDefinedCaptureProtocol_ResolveBuffer::BufferName' has a wrong offset!");
static_assert(offsetof(UserDefinedCaptureProtocol_ResolveBuffer, Handler) == 0x000010, "Member 'UserDefinedCaptureProtocol_ResolveBuffer::Handler' has a wrong offset!");
...
static_assert(alignof(UserDefinedCaptureProtocol_StartCapturingFinalPixels) == 0x000004, "Wrong alignment on UserDefinedCaptureProtocol_StartCapturingFinalPixels");
static_assert(sizeof(UserDefinedCaptureProtocol_StartCapturingFinalPixels) == 0x000008, "Wrong size on UserDefinedCaptureProtocol_StartCapturingFinalPixels");
static_assert(offsetof(UserDefinedCaptureProtocol_StartCapturingFinalPixels, StreamName) == 0x000000, "Member 'UserDefinedCaptureProtocol_StartCapturingFinalPixels::StreamName' has a wrong offset!");
...
static_assert(sizeof(UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer) == 0x000020, "Wrong size on UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer");
...
static_assert(offsetof(UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer, StreamName) == 0x000008, "Member 'UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer::StreamName' has a wrong offset!");
static_assert(offsetof(UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer, ReturnValue) == 0x000010, "Member 'UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(UserDefinedImageCaptureProtocol_WriteImageToDisk) == 0x000030, "Wrong size on UserDefinedImageCaptureProtocol_WriteImageToDisk");
...
static_assert(offsetof(UserDefinedImageCaptureProtocol_WriteImageToDisk, StreamName) == 0x000010, "Member 'UserDefinedImageCaptureProtocol_WriteImageToDisk::StreamName' has a wrong offset!");
static_assert(offsetof(UserDefinedImageCaptureProtocol_WriteImageToDisk, FrameMetrics) == 0x000018, "Member 'UserDefinedImageCaptureProtocol_WriteImageToDisk::FrameMetrics' has a wrong offset!");
static_assert(offsetof(UserDefinedImageCaptureProtocol_WriteImageToDisk, bCopyImageData) == 0x000028, "Member 'UserDefinedImageCaptureProtocol_WriteImageToDisk::bCopyImageData' has a wrong offset!");
