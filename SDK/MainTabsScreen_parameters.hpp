...
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_nonMinusMTX_offers_are_purchasable, CallFunc_Not_PreBool_ReturnValue1) == 0x0000D2, "Member 'MainTabsScreen_C_Determine_If_Any_nonMinusMTX_offers_are_purchasable::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabsScreen_C_Determine_If_Any_nonMinusMTX_offers_are_purchasable, CallFunc_BooleanAND_ReturnValue1) == 0x0000D4, "Member 'MainTabsScreen_C_Determine_If_Any_nonMinusMTX_offers_are_purchasable::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
