...
static_assert(offsetof(StoreWeaponMaster_BP_C_ExecuteUbergraph_StoreWeaponMaster_BP, K2Node_CustomEvent_Loaded) == 0x000008, "Member 'StoreWeaponMaster_BP_C_ExecuteUbergraph_StoreWeaponMaster_BP::K2Node_CustomEvent_Loaded' has a wrong offset!");
static_assert(offsetof(StoreWeaponMaster_BP_C_ExecuteUbergraph_StoreWeaponMaster_BP, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'StoreWeaponMaster_BP_C_ExecuteUbergraph_StoreWeaponMaster_BP::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
