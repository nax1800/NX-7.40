...
static_assert(sizeof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors) == 0x000088, "Wrong size on AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors");
...
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, __WorldContext) == 0x000020, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::__WorldContext' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, HitActors) == 0x000028, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::HitActors' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, LocalHitActors) == 0x000038, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::LocalHitActors' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_GetDataCountFromTargetData_ReturnValue) == 0x000048, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_GetDataCountFromTargetData_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, Temp_int_Variable) == 0x00004C, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_Subtract_IntInt_ReturnValue) == 0x000050, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_GetActorsFromTargetData_ReturnValue) == 0x000058, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_GetActorsFromTargetData_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000068, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_Array_Get_Item) == 0x000070, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_NotEqual_ObjectObject_ReturnValue) == 0x000078, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_NotEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_Add_IntInt_ReturnValue) == 0x00007C, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors, CallFunc_Array_Add_ReturnValue) == 0x000080, "Member 'AbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
