...
static_assert(offsetof(ItemInspectUpgradeCallout_C_SetButtonsEnabled, Param_bIsEnabled) == 0x000000, "Member 'ItemInspectUpgradeCallout_C_SetButtonsEnabled::Param_bIsEnabled' has a wrong offset!");
