...
static_assert(offsetof(ChoiceCardName_C_UpdateText, CallFunc_GetDynamicMaterial_ReturnValue1) == 0x0000A8, "Member 'ChoiceCardName_C_UpdateText::CallFunc_GetDynamicMaterial_ReturnValue1' has a wrong offset!");
