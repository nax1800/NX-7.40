...
static_assert(sizeof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization) == 0x000078, "Wrong size on ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization");
...
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization, Temp_object_Variable2) == 0x000018, "Member 'ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization::Temp_object_Variable2' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization, Temp_object_Variable3) == 0x000020, "Member 'ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization::Temp_object_Variable3' has a wrong offset!");
