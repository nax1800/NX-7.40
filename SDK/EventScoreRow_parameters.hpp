...
static_assert(offsetof(EventScoreRow_C_ExecuteUbergraph_EventScoreRow, Temp_byte_Variable1) == 0x000006, "Member 'EventScoreRow_C_ExecuteUbergraph_EventScoreRow::Temp_byte_Variable1' has a wrong offset!");
