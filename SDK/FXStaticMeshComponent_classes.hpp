...
static_assert(alignof(UFXStaticMeshComponent_C) == 0x000008, "Wrong alignment on UFXStaticMeshComponent_C");
static_assert(sizeof(UFXStaticMeshComponent_C) == 0x000630, "Wrong size on UFXStaticMeshComponent_C");
