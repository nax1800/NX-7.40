...
static_assert(sizeof(LeaderboardRowWidget_C_ExecuteUbergraph_LeaderboardRowWidget) == 0x000020, "Wrong size on LeaderboardRowWidget_C_ExecuteUbergraph_LeaderboardRowWidget");
