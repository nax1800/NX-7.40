...
static_assert(sizeof(UGCN_RiftSpawnFiend_C) == 0x0001A8, "Wrong size on UGCN_RiftSpawnFiend_C");
static_assert(offsetof(UGCN_RiftSpawnFiend_C, ConcurrencySettings) == 0x0001A0, "Member 'UGCN_RiftSpawnFiend_C::ConcurrencySettings' has a wrong offset!");
