...
static_assert(alignof(McpProfile_DeleteAllProfiles) == 0x000008, "Wrong alignment on McpProfile_DeleteAllProfiles");
static_assert(sizeof(McpProfile_DeleteAllProfiles) == 0x000038, "Wrong size on McpProfile_DeleteAllProfiles");
...
static_assert(alignof(McpProfile_DeleteProfile) == 0x000008, "Wrong alignment on McpProfile_DeleteProfile");
static_assert(sizeof(McpProfile_DeleteProfile) == 0x000038, "Wrong size on McpProfile_DeleteProfile");
...
static_assert(alignof(McpProfile_LockProfileForWrite) == 0x000008, "Wrong alignment on McpProfile_LockProfileForWrite");
static_assert(sizeof(McpProfile_LockProfileForWrite) == 0x000050, "Wrong size on McpProfile_LockProfileForWrite");
...
static_assert(offsetof(McpProfile_LockProfileForWrite, Context) == 0x000018, "Member 'McpProfile_LockProfileForWrite::Context' has a wrong offset!");
...
static_assert(alignof(McpProfile_QueryProfile) == 0x000008, "Wrong alignment on McpProfile_QueryProfile");
static_assert(sizeof(McpProfile_QueryProfile) == 0x000038, "Wrong size on McpProfile_QueryProfile");
...
static_assert(alignof(McpProfile_QueryPublicProfile) == 0x000008, "Wrong alignment on McpProfile_QueryPublicProfile");
static_assert(sizeof(McpProfile_QueryPublicProfile) == 0x000038, "Wrong size on McpProfile_QueryPublicProfile");
...
static_assert(alignof(McpProfile_UnlockProfileForWrite) == 0x000008, "Wrong alignment on McpProfile_UnlockProfileForWrite");
static_assert(sizeof(McpProfile_UnlockProfileForWrite) == 0x000048, "Wrong size on McpProfile_UnlockProfileForWrite");
