...
static_assert(offsetof(UMissionStartObjectivePanel_C, HoverStateMinusOff) == 0x000280, "Member 'UMissionStartObjectivePanel_C::HoverStateMinusOff' has a wrong offset!");
static_assert(offsetof(UMissionStartObjectivePanel_C, HoverStateMinusOn) == 0x000288, "Member 'UMissionStartObjectivePanel_C::HoverStateMinusOn' has a wrong offset!");
