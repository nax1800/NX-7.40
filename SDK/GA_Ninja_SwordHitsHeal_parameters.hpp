...
static_assert(sizeof(GA_Ninja_SwordHitsHeal_C_ExecuteUbergraph_GA_Ninja_SwordHitsHeal) == 0x0000B0, "Wrong size on GA_Ninja_SwordHitsHeal_C_ExecuteUbergraph_GA_Ninja_SwordHitsHeal");
...
static_assert(sizeof(GA_Ninja_SwordHitsHeal_C_K2_ActivateAbilityFromEvent) == 0x0000A8, "Wrong size on GA_Ninja_SwordHitsHeal_C_K2_ActivateAbilityFromEvent");
...
static_assert(sizeof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent) == 0x0000F0, "Wrong size on GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent");
...
static_assert(offsetof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent, ReturnValue) == 0x0000E8, "Member 'GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent::ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent, CallFunc_ShouldSwordHitsHealRespondToEvent_ReturnValue) == 0x0000E9, "Member 'GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent::CallFunc_ShouldSwordHitsHealRespondToEvent_ReturnValue' has a wrong offset!");
