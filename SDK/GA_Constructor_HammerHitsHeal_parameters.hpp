...
static_assert(sizeof(GA_Constructor_HammerHitsHeal_C_ExecuteUbergraph_GA_Constructor_HammerHitsHeal) == 0x0000B0, "Wrong size on GA_Constructor_HammerHitsHeal_C_ExecuteUbergraph_GA_Constructor_HammerHitsHeal");
...
static_assert(sizeof(GA_Constructor_HammerHitsHeal_C_K2_ShouldAbilityRespondToEvent) == 0x0000F0, "Wrong size on GA_Constructor_HammerHitsHeal_C_K2_ShouldAbilityRespondToEvent");
