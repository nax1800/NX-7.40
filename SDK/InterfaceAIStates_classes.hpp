...
static_assert(alignof(IInterfaceAIStates_C) == 0x000008, "Wrong alignment on IInterfaceAIStates_C");
static_assert(sizeof(IInterfaceAIStates_C) == 0x000028, "Wrong size on IInterfaceAIStates_C");
