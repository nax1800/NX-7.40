...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, Temp_byte_Variable2) == 0x000018, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::Temp_byte_Variable2' has a wrong offset!");
...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, Temp_byte_Variable3) == 0x00001A, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::Temp_byte_Variable3' has a wrong offset!");
