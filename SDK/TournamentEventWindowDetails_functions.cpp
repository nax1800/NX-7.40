...
// Function TournamentEventWindowDetails.TournamentEventWindowDetails_C.NewEventDispatcher_0__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UTournamentEventWindowDetails_C::NewEventDispatcher_0__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TournamentEventWindowDetails_C", "NewEventDispatcher_0__DelegateSignature");
