...
static_assert(offsetof(AthenaGenericLobbyViolator_C_SetGamemodeName, CallFunc_TextToUpper_ReturnValue1) == 0x000050, "Member 'AthenaGenericLobbyViolator_C_SetGamemodeName::CallFunc_TextToUpper_ReturnValue1' has a wrong offset!");
