...
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteResultAnimationMinusUNUSED) == 0x000290, "Member 'UMissionVotingDetailsPanel_C::VoteResultAnimationMinusUNUSED' has a wrong offset!");
...
static_assert(offsetof(UMissionVotingDetailsPanel_C, TimeTypeIconMinus1) == 0x000358, "Member 'UMissionVotingDetailsPanel_C::TimeTypeIconMinus1' has a wrong offset!");
static_assert(offsetof(UMissionVotingDetailsPanel_C, VoteMinusResultMinusGlow) == 0x000360, "Member 'UMissionVotingDetailsPanel_C::VoteMinusResultMinusGlow' has a wrong offset!");
