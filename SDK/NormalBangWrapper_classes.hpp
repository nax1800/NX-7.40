...
static_assert(offsetof(UNormalBangWrapper_C, NoMinusCount) == 0x0002B0, "Member 'UNormalBangWrapper_C::NoMinusCount' has a wrong offset!");
static_assert(offsetof(UNormalBangWrapper_C, NoMinusCountMinus1) == 0x0002B8, "Member 'UNormalBangWrapper_C::NoMinusCountMinus1' has a wrong offset!");
