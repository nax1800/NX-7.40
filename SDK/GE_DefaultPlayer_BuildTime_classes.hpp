...
static_assert(alignof(UGE_DefaultPlayer_BuildTime_C) == 0x000008, "Wrong alignment on UGE_DefaultPlayer_BuildTime_C");
static_assert(sizeof(UGE_DefaultPlayer_BuildTime_C) == 0x0005F0, "Wrong size on UGE_DefaultPlayer_BuildTime_C");
