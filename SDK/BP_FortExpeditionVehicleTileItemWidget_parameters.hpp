...
static_assert(alignof(BP_FortExpeditionVehicleTileItemWidget_C_OnVehicleSelected__DelegateSignature) == 0x000004, "Wrong alignment on BP_FortExpeditionVehicleTileItemWidget_C_OnVehicleSelected__DelegateSignature");
...
static_assert(sizeof(BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget) == 0x000020, "Wrong size on BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget");
...
static_assert(offsetof(BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget, K2Node_Event_ListItemObject) == 0x000008, "Member 'BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget::K2Node_Event_ListItemObject' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget, K2Node_DynamicCast_AsVehicle_Object) == 0x000010, "Member 'BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget::K2Node_DynamicCast_AsVehicle_Object' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'BP_FortExpeditionVehicleTileItemWidget_C_ExecuteUbergraph_BP_FortExpeditionVehicleTileItemWidget::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
static_assert(alignof(BP_FortExpeditionVehicleTileItemWidget_C_OnListItemObjectSet) == 0x000008, "Wrong alignment on BP_FortExpeditionVehicleTileItemWidget_C_OnListItemObjectSet");
static_assert(sizeof(BP_FortExpeditionVehicleTileItemWidget_C_OnListItemObjectSet) == 0x000008, "Wrong size on BP_FortExpeditionVehicleTileItemWidget_C_OnListItemObjectSet");
static_assert(offsetof(BP_FortExpeditionVehicleTileItemWidget_C_OnListItemObjectSet, ListItemObject) == 0x000000, "Member 'BP_FortExpeditionVehicleTileItemWidget_C_OnListItemObjectSet::ListItemObject' has a wrong offset!");
...
static_assert(sizeof(BP_FortExpeditionVehicleTileItemWidget_C_Set_Icon) == 0x000340, "Wrong size on BP_FortExpeditionVehicleTileItemWidget_C_Set_Icon");
