...
static_assert(alignof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove) == 0x000008, "Wrong alignment on GCNL_GM_MaxHealthIncrease_Major_C_OnRemove");
static_assert(sizeof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove) == 0x0000D8, "Wrong size on GCNL_GM_MaxHealthIncrease_Major_C_OnRemove");
static_assert(offsetof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove, MyTarget) == 0x000000, "Member 'GCNL_GM_MaxHealthIncrease_Major_C_OnRemove::MyTarget' has a wrong offset!");
static_assert(offsetof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove, Parameters) == 0x000008, "Member 'GCNL_GM_MaxHealthIncrease_Major_C_OnRemove::Parameters' has a wrong offset!");
static_assert(offsetof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove, ReturnValue) == 0x0000C0, "Member 'GCNL_GM_MaxHealthIncrease_Major_C_OnRemove::ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove, K2Node_DynamicCast_AsEnemy_Pawn_Parent) == 0x0000C8, "Member 'GCNL_GM_MaxHealthIncrease_Major_C_OnRemove::K2Node_DynamicCast_AsEnemy_Pawn_Parent' has a wrong offset!");
static_assert(offsetof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove, K2Node_DynamicCast_bSuccess) == 0x0000D0, "Member 'GCNL_GM_MaxHealthIncrease_Major_C_OnRemove::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GCNL_GM_MaxHealthIncrease_Major_C_OnRemove, CallFunc_IsValid_ReturnValue) == 0x0000D1, "Member 'GCNL_GM_MaxHealthIncrease_Major_C_OnRemove::CallFunc_IsValid_ReturnValue' has a wrong offset!");
