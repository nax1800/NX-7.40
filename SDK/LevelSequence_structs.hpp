...
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x000088, "Wrong size on FLevelSequencePlayerSnapshot");
...
static_assert(offsetof(FLevelSequencePlayerSnapshot, ShotID) == 0x000084, "Member 'FLevelSequencePlayerSnapshot::ShotID' has a wrong offset!");
