...
static_assert(alignof(UGET_ModifyPhysicalDamage_C) == 0x000008, "Wrong alignment on UGET_ModifyPhysicalDamage_C");
static_assert(sizeof(UGET_ModifyPhysicalDamage_C) == 0x0005F0, "Wrong size on UGET_ModifyPhysicalDamage_C");
